...
class Test_Mirrorly_API_Client_Integration extends Mirrorly_Test_Case {
    ...
    public function test_generation_status_checking() {
        Mirrorly_API_Mock::set_mock_response('generate/status/test123', array(
            'status' => 'processing',
            'progress' => 50
        ));
    ...
    public function test_generation_result_retrieval() {
        Mirrorly_API_Mock::set_mock_response('generate/result/test123', array(
            'status' => 'completed',
    ...
    public function test_api_connection_testing() {
        Mirrorly_API_Mock::set_mock_response('auth/status', array(
            'authenticated' => true,
    ...
    public function test_api_health_check() {
        Mirrorly_API_Mock::set_mock_response('health', array(
            'status' => 'healthy',
            'version' => '1.0.0'
        ));
    ...
    public function test_multiple_generation_status_checking() {
        Mirrorly_API_Mock::set_mock_response('generate/status/batch', array(
            'results' => array(
    ...
    public function test_async_image_generation() {
        // Mock prerequisites
        Mirrorly_API_Mock::mock_rate_limit_check(true, 5);
        Mirrorly_API_Mock::set_mock_response('generate/image-async', array(
            'success' => true,
