...
class Test_Mirrorly_Frontend extends Mirrorly_Test_Case {
    ...
    public function test_ajax_image_generation() {
        ...
        $response = $this->mock_ajax_request('mirrorly_generate_image', array(
    ...
    public function test_ajax_generation_status_check() {
        ...
        $response = $this->mock_ajax_request('mirrorly_check_generation_status', array(
    ...
    public function test_widget_display_pro_styling() {
        ...
        // Set custom styling
        $this->set_plugin_option('widget_styling', array(
            'border_radius' => '12',
            'button_style' => 'pill',
            'animation' => 'slide',
            'shadow' => 'heavy'
