...
class Mirrorly_API_Client {
    ...
    public function generate_image_async($user_image_path, $product_image_path, $product_id, $options = array()) {
        ...
        if (isset($response['generationId'])) {
            $this->store_generation_record($product_id, $user_image_path, $product_image_path, array(
    ...
    private function process_response($response) {
        ...
        return new WP_Error($error_code, $error_message, array('status' => $response_code, 'response_data' => $data));
    }
